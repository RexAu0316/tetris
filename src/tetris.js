...
// Handle the case where rotation fails
// We can attempt to shift left or right
...
after i update the code when i start the game it show this error to me
...
if (tetromino.shape[i][j]) { // If part of the tetromino
if (
